defmodule BlogApp.Web.SessionControllerTest do
  ...
  describe "authenticated" do
    ...
    test "logout when authenticated", %{conn: conn, user: user} do
      ...
      conn = delete conn, session_path(conn, :delete, current_user.id)
  ...
  describe "unauthenticated" do
    setup do
      user_attrs = params_for(:user, %{role: insert(:role), username: @username, password: @password, password_confirmation: @password})
