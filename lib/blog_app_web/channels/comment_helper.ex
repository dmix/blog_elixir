defmodule BlogAppWeb.CommentHelper do
  alias BlogApp.Blog
  ...
  @spec authorize_and_perform(number, number, fun) :: {:ok, any} | {:error, any}
  ...
  @spec is_authorized_user?(Ecto.Repo.t, Ecto.Repo.t) :: boolean
